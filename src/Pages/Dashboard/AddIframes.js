...
import AddIframesModal from '../../Components/Modals/AddIframes'
...
const AddIframes = () => {
    ...
    const renderImage = ({ row: { image, name } }) => {
        return <TableImage image={image} name={name} />
    }
    ...
    return (
        <div>
            <AddIframesModal onClose={onClose} open={open} />
